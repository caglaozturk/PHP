...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>BAY - BAYAN <span>ÜRÜNLER  </span></h3>
			<!--/w3_short-->
	...
	<div class="container">
		...
		<div class="col-md-4 products-left">
			<div class="filter-price">
				<h3>FİLTRELE <span>FİYATA GÖRE</span></h3>
		...
		<div class="col-md-8 products-right">
			<h5>Ürün <span>Kıyaslama</span></h5>
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="<?=base_url()?>assets/images/bb1.jpg" alt=" " />
				</div>
		...
		<div class="col-md-4 product-men">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?=base_url()?>assets/images/b7.jpg" alt="" class="pro-image-front">
										<img src="<?=base_url()?>assets/images/b7.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="#" class="link-product-add-cart">Quick View</a>
												</div>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?=base_url()?>assets/images/s6.jpg" alt="" class="pro-image-front">
										<img src="<?=base_url()?>assets/images/s6.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="#" class="link-product-add-cart">Quick View</a>
												</div>
