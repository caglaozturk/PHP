                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Ürün Resmi Ekleme </strong> Sayfası</h3>
                                </div>
                                ...
                                <div class="panel-body"> 
                                    <div class="form-group">
                                        <div class="col-md-6 col-xs-12"> 
                                            <input name="resim" type="file" class="form-control" required class="form-control" placeholder="Yükleme için gözat"/>
                                        </div>
                                    </div>							
                                </div>
